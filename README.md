...
| 层 | 技术 |
|---|---|
| 后端 | Go 1.26.5 · gRPC · gjson/sjson（零 struct）· gorilla/websocket |
...
需要 Go 1.26.5+、Node 22+，以及兄弟目录 [`airgate-sdk`](https://github.com/DevilGenius/airgate-sdk) 与 [`airgate-core`](https://github.com/DevilGenius/airgate-core)：
